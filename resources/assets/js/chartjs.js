...
$(function() {
  ...
  Chart.defaults.global.responsive = true;
  var _ctx = $('#polar-area-chart').get(0);
  if(_ctx && _ctx.length>0) {
...
$(function() {
  var ctx, data, myLineChart, options;
  Chart.defaults.global.responsive = true;
  var _ctx = $('#jumbotron-line-chart').get(0);
  if(_ctx && _ctx.length>0) {
