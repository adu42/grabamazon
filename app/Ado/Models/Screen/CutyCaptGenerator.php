...
use  App\Ado\Models\Screen\Xvfbrun as xvfb_run;


class CutyCaptGenerator extends abstractGenerator {
    ...
    function __construct(xvfb_run $xvfb_run = null)
    {
        $this->xvfb_run = $xvfb_run;
        $this->files_dir = config('app.upload_dir').DIRECTORY_SEPARATOR;
