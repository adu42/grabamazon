...
return [
    ...
    'vmenu_name'=> 'user_menu',
    'template'=>'frontend.default.',
    'site_name'=>'Real Customer Reviews, Feedbacks &amp; Complaints For Online Shopping Site - RatingGet.com',
    'site_keywords'=>'Reviews, Feedbacks, Complaints.',
    'site_description'=>'RatingGet.com is all about consumer reviews. Get the real inside story from shoppers like you. Read, write and share reviews on RatingGet today.',
    'welcome'=>['title'=>'Hello,World',
        'description'=>'Hello RatingGet.com',
    ] ,
    'str_limit'=>[
        'carousel'=>100,
        'articles'=>120,
    ],
    'socialite_login_used'=>true,
    'socialite'=>[  //社交登陆按钮
        'facebook',
        'google',
     //   'linkedin',
    ...
    'review'=>[
        ...
        'auto'=>true,
        'auto_number'=>3,
        'external_link_count_prison'=>2,
        'external_link_count_prison_days'=>15,
        'bad_word_count_prison'=>3,
        'bad_word_count_prison_days'=>3,
    ],
    'coupon_title'=>'title of page coupon list',
    'coupon_keyword'=>'keywords of page coupon list',
    'coupon_description'=>'description of page coupon list',
    'qq'=>['connect'=>[
            'appid'=>'101235668',
            'scope'=>'get_user_info',
            'appkey'=>'1fc86142fefb7e1e239879f40f2c062d',
    ...
    // htmlto imags|pdf start //
    'winnt_binary_path'=>app_path('lib'),
    'linux_binary_path'=>'/usr/local/bin/wkhtmltoimage',
    'linux_binary_path_pdf'=>'/usr/local/bin/wkhtmltopdf',
    'save_to'=>public_path('screens'),
    'file_prex'=>'D',
    'image_file_extension'=>'jpg',
    'pdf_file_extension'=>'pdf',
    'file_web_path'=>'/screens/',
    'save_to_image_options'=>[
