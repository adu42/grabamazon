...
@if ($dg->getUpdataFiled('html'))
    ...
    @include('rapyd::toolbar', array('label'=>$label, 'buttons_right'=>$buttons['TR'],'html'=>$dg->getUpdataFiled('html'),'other'=>$dg->getUpdataFiled('other')))
@else
...
@if ($dg->getUpdataFiled('html'))
    @include('rapyd::toolbar', array('buttons_left'=>$buttons['BL'],'buttons_right'=>$buttons['BR'],'html'=>$dg->getUpdataFiled('html'),'other'=>$dg->getUpdataFiled('other')))
